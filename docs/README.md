...
Reference circuit files have moved to [circuits/](../circuits/README.md). Historical
commands may name generated run files at the working-directory root; these are
different from the preserved reference examples. New measurements should generate
new local outputs rather than overwrite the published summaries.
